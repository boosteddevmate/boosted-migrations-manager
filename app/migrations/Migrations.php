...
require_once @getcwd().'/system/config/database.php';

define('SERVER_NAME', $database_config['host']);

define('USER_NAME', $database_config['username']);

define('PASSWORD', $database_config['password']);

define('DATABASE_NAME', $database_config['database'] );

define('PORT', 3306);

$mysqli = mysqli_connect(SERVER_NAME,USER_NAME,PASSWORD,DATABASE_NAME);
define("SQL_SERVER_VERSION", mysqli_get_server_info($mysqli));
/**
